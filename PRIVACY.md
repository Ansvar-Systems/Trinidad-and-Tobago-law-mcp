...
This document addresses privacy and confidentiality considerations when using this Tool, with particular attention to professional obligations under Trinidadian legal professional rules.
...
- Law Society of Trinidad and Tobago rules require strict confidentiality and data handling controls

**Safe Use Options:**
1. **General Legal Research**: Use Tool for non-client-specific queries
2. **Local npm Package**: Install `@ansvar/trinidadian republic-law-mcp` locally — database queries stay on your machine
...
```bash
npx @ansvar/trinidadian republic-law-mcp
```
...
```
Endpoint: https://trinidadian republic-law-mcp.vercel.app/mcp
```
...
## Professional Obligations (Trinidad and Tobago)

### Law Society of Trinidad and Tobago and Advocates Act

Trinidadian lawyers (advocates) are bound by strict confidentiality rules under the Advocates Act (Cap 16) and the Law Society of Trinidad and Tobago Code of Standards of Professional Practice and Ethical Conduct.
...
3. Client matters: Use commercial legal databases (Trinidad and Tobago Law Reports, LexisNexis East Africa)
...
2. Follow Trinidadian government information security requirements
...
- **Privacy Questions**: Open issue on [GitHub](https://github.com/Ansvar-Systems/trinidadian republic-law-mcp/issues)
- **Anthropic Privacy**: Contact privacy@anthropic.com
- **LSK Guidance**: Consult Law Society of Trinidad and Tobago ethics guidance
